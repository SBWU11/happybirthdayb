document.addEventListener('DOMContentLoaded', function() {
  // Wait for initial loader to finish
  setTimeout(function() {
    var typed = new Typed('#typed', {
      stringsElement: '#typed-strings',
      typeSpeed: 40,
      backSpeed: 20,
      startDelay: 1000,    // Delay before starting the animation (in milliseconds)
      backDelay: 1700,     // Delay before backspacing/changing to next text (in milliseconds)
      loop: true,
      showCursor: true,
      cursorChar: '|',
  ...
  }, 4000);  // Match your loader timeout
});
